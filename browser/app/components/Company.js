  ...
  render: function() {
    return (
      <div style={CompanyStyle.ContactsStyle}>
        <span className="col-md-4 footerText"><span className="glyphicon glyphicon-envelope"></span>{" " + this.props.email + "  "}</span>
        <span className="col-md-4 footerText"><span className="glyphicon glyphicon-copyright-mark"></span>{" " + " Copyright Pico Technology 2015"}</span>
         <span className="col-md-4 footerText"><span className="glyphicon glyphicon-flag"></span> {" " + this.props.location}</span>
      </div>
    );
  }
});
